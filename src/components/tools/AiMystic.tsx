  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] gap-8 animate-fade-in">
      ...
      <div className="relative w-48 h-48 flex items-center justify-center">
        <div className={`absolute inset-0 rounded-full bg-gradient-to-br from-neon-violet/30 to-neon-cyan/30 ${thinking ? "animate-spin" : "animate-pulse-glow"}`}
        ...
        <div className="relative w-40 h-40 rounded-full glass-card-highlight flex items-center justify-center neon-glow-violet">
          <div className="text-center p-4">
            {thinking ? (
              ...
              <p className="text-sm font-semibold neon-text-cyan">{answer}</p>
            ) : (
      ...
      <div className="w-full max-w-md flex gap-2">
        ...
        <button
          onClick={ask}
          disabled={thinking}
          className="px-6 py-3 rounded-lg bg-primary/20 border border-primary/40 text-primary font-semibold hover:bg-primary/30 transition-all disabled:opacity-50 neon-glow-cyan"
        >
          Ask
        </button>
      </div>
